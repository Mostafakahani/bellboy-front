...
export const DashboardInput: React.FC<DashboardInputProps> = ({
  ...
  const baseInputClasses =
    "w-full px-3 py-3 border border-gray-300 border-black rounded-xl focus:outline-none focus:ring-0 focus:ring-blue-500 placeholder-black/90 placeholder:text-sm";
  const labelClasses = "block mb-1 mr-2 text-sm text-right";
        ...
        return (
          <div className="relative">
            ...
            <input
              {...props}
              className={
                "pl-10 w-full px-3 py-3 border-b-2 border-black focus:outline-none focus:ring-0 focus:ring-blue-500 placeholder-black/90 placeholder:text-sm"
              }
              onChange={onChange}
            />
          </div>
